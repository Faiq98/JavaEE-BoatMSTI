<%-- 
    ...
    Created on : Feb 26, 2020, 3:15:08 PM
    Author     : fhfai
--%>
...
<html>
    ...
    <body>
        <%
            ...
            int serviceID = Integer.parseInt((String) request.getAttribute("serviceID"));
        ...
        <div class="container tch" style="font-size: 20px;">
            <div class="tchprofile"> 
                ...
                <div class="row">
                    <div class="col">
                        <h3 style="display: inline">Edit Boat Service <i class="fa fa-service tchicon"></i></h3>
                    </div>
                </div>
            </div>
            <div class="row mt-5">
            ...
            <form action="boatServiceCtrl" method="post">
                <div class="card" style="padding: 30px; box-shadow: 1px 1px 5px #777;">
                    <input type="hidden" name="action" value="editBoatService"/>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="boatID">
                                    <option hidden value="<%= bsb.getBoatID().getBoatID() %>"><%= bsb.getBoatID().getBoatID() %> | <%= bsb.getBoatID().getBoatType() %> | <%= bsb.getBoatID().getBoatCapacity() %></option>
                                    <%
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="<%= bsb.getDepartureTime() %>" name="departureTime" required/>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="<%= bsb.getServiceName() %>" name="serviceName" required/>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="fromLocation">From Location</label>
                                <input list="fromlist" type="text" class="form-control" value="<%= bsb.getFromLocation() %>" name="fromLocation" required/>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input list="tolist" type="text" class="form-control" value="<%= bsb.getToLocation() %>" name="toLocation" required/>
                                <datalist id="tolist">
                                    <option value="Kapas Island">Kapas Island</option>
                                    <option value="Redang Island">Redang Island</option>
                                    <option value="Lang Tengah Island">Lang Tengah Island</option>
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" value="<%= bsb.getAdultPrice() %>" name="AdultPrice" required/>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="ChildPrice">Child Price</label>
                            <input type="text" class="form-control" value="<%= bsb.getChildPrice() %>" name="ChildPrice" required/>
                        </div>
                        <div class="form-group col-md-4">
                            <label for="Infant Price">Infant Price</label>
                            <input type="text" class="form-control" value="<%= bsb.getInfantPrice() %>" name="InfantPrice" required/>
                        </div>
                    </div>
                </div>
