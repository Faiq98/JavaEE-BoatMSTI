<%-- 
    Document   : AddBoat
    Created on : Feb 25, 2020, 9:10:10 PM
    Author     : fhfai
--%>
    ...
    <body>
        ...
        <div class="container tch" style="font-size: 20px;">
            <div class="tchprofile"> 
                ...
                <div class="row">
                    <div class="col">
                        <h3 style="display: inline">Add Company Boat <i class="fa fa-ship tchicon"></i></h3>
                    </div>
                </div>
            </div>
            <div class="row mt-5">
            ...
            <form action="boatCtrl" method="post">
                <div class="card" style="padding: 30px; box-shadow: 1px 1px 5px #777;">
                    ...
                    <input type="hidden" value="<%= tcb.getCompanyID()%>" name="companyID"/>

                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="boatID">Register No:</label>
                                <input type="text" class="form-control" placeholder="Register No" name="boatID" required/>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="boatTpe">Boat Type:</label>
                                <input list="typelist" type="text" class="form-control" placeholder="Choose Boat Type" name="boatType" required/>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Boat Capacity" name="boatCapacity" required/>
                            </div>
                        </div>
                    </div>
                </div>
